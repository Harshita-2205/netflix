/** @format */
import "./style.css";
import {FAQ} from "./script.js";

const Sec6 = () => {
	return (
		<div>
			<div
				className="sec_6 flex flex-col p-12">
				<div>
					<h1 className='text-center'>Frequently Asked Questions</h1>
				</div>
				<div className="flex flex-wrap items-center justify-center pb-20">
					
						<button className='accordion' onClick={FAQ}>What is Netflix?</button>
						<div className="panel">
							<p>
					...
					<button className="accordion" onClick={FAQ}>
